...
export default function ProjectsSection() {
	return (
		...
		>
			...
			<div className="grid gap-8 w-full max-w-3xl grid-cols-1 sm:grid-cols-2">
				{projects.map((project) => (
					...
					>
						...
						{/* Project Card */}
						<div
							className="flex flex-col gap-4 border-gray-50 shadow-none hover:shadow-sm shadow-blue-100 transition-shadow duration-300 transform-gpu will-change-transform rounded-3xl bg-white p-4 mt-2"
						>
							...
							<div className="flex justify-end mb-2">
								{project.stack.map((tech) => (
									...
									>
										{tech}
										{tech !==
											project.stack[project.stack.length - 1] && ","}
									</span>
								))}
							</div>
